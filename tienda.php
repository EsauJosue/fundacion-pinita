...
<!-- FORMULARIO PARA REGISTRAR EL PEDIDO -->
        <div class="overlay">
          <div class="content__form content__tienda_box-form" id="comprar-<?php echo $dato->id_producto?>">
            ...
            <form action="insert_pedido.php" class="content__form" method="POST" id="comprar-<?php echo $dato->id_producto?>">
          ...
          <div class="content__form__box">
            ...
            <input type="text" placeholder="name@email.com" name="email" class="content__form__box-input" id="txtEmail" required>
          </div>
          ...
          <div class="content__form__box">
            <label class="content__form__box-label" for="txtFraccionamiento">Fraccionamiento: </label>
            <input type="text" placeholder="Ingrese el fraccionamiento" name="fraccionamiento" class="content__form__box-input" id="txtFraccionamiento" required>
          </div>
          <div class="content__form__box">
          ...
          <div class="content__form__box content__tienda_box-form-details">
            <label class="content__form__box-label" for="idProd">Producto: </label>
            <input type="text" placeholder="Ingrese Código Postal" name="id_producto" class="content__form__box-input" id="idProd" value="<?php echo $dato->id_producto?>">
