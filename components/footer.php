...
<footer>
    ...
    <div class="footer__header__box">
      ...
      <div class="footer__header__box__email"> 
        ...
        <div class="footer__header__email-txt"> 
          <p>contacto@fundacionpinita.org</p>
        </div>
      </div>
    </div>
  </div>
  <div class="footer__box">
    <div class="footer__box__body">
      <div class="footer__box__body-logo"><img src="/images/logotipo.svg" alt="logotipo Fundación Pinita"/></div>
      <div class="footer__box__body-links">
        <h2>Enlaces Directos</h2>
        <ul> 
          <li><a href="index.php">Inicio</a></li>
          <li><a href="fundacion.php">Fundación Pinita</a></li>
      ...
      <div class="footer__box__body-address"> <img src="images/Iconos/address.svg" alt="ícono de ubicación"/>
        <p>Calle Belice 211 Col. Santa Elena, C.P. 20230, Aguascalientes, Ags.</p>
      </div>
      ...
      <div class="footer__box__body-socialmedia">
        <div class="footer__box__body-socialmedia__icon">
          <h2>SÍGUENOS</h2><a href="https://www.facebook.com/FundacionPinita"> <img src="images/Iconos/facebook.svg" alt="Ícono de facebook"/></a>
        </div>
      </div>
    </div>
    <div class="footer__foot"> 
      ...
      <div class="link__jmc"> <a href="https://esaujosue.dev" target="_blank">Desarrollado por <strong>Esaú Josué Martínez Carrasco</strong>  </a></div>
    </div>
  </div>
