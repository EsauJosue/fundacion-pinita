...
<div class="content">
    <div class="content__menu-principal">
       <div class="content__menu-principal__button">
        <button class="btn-abrir-popup" ><img src="/images/Iconos/add-user.png" alt="">Agregar Usuario</button>
       </div>
       <div class="content__menu-principal__button">
       <button class="btn-abrir-popup" ><img src="/images/Iconos/edit-user.png" alt="">Ver/Editar Usuario</button>
       </div>
    </div>
    <div class="overlay">
        <div class="content__form popup">
            <form action="insert_staff.php" class="content__form" method="POST">
            <a href="#" id="btn-cerrar-popup" class="btn-cerrar-popup"><img src="/images/Iconos/xmark-solid.svg" alt=""></a>
