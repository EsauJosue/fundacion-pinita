...
$pdf->Cell(0,6,utf8_decode('Reporte de Benefactores'),0,1,'C');
$pdf->Image('../images/logotipo-pinita.png', 10, 10, 30, 20);
$consulta = $bd->query("SELECT nombre,telefono,domicilio FROM usuarios WHERE perfil = 'benefactor';");
...
$pdf->Cell(60,10,utf8_decode('DOMICILIO'),1,0,'L');
$pdf->Ln(10);
...
foreach ($aportaciones as $dato){
    ...
    $pdf->Cell(60,10,utf8_decode(''.$domicilio),0,0,'L');
